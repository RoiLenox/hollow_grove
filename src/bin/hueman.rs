...
use hollow_grove::hueman_support::{
    ...
    build_hueman_motion_map_from_artifacts, hueman_boundary_artifact_path,
    hueman_motion_map_artifact_path,
};
use hollow_grove::{read_text_artifact, write_text_artifact};

fn run_hueman_at(root: &Path) -> io::Result<[PathBuf; 2]> {
    ...
    Ok([boundary_path, motion_map_path])
}
...
mod tests {
    ...
    #[test]
    fn hueman_runner_regenerates_boundary_and_motion_map_in_order() {
        ...
        let [boundary_path, motion_map_path] =
