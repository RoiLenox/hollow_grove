...
use hollow_grove::hueman_support::{
    ...
    build_hueman_start_choices_from_artifacts, hueman_aura_triad_artifact_path,
...
fn run_hueman_at(root: &Path) -> io::Result<[PathBuf; 5]> {
...
mod tests {
    ...
    #[test]
    fn hueman_runner_regenerates_boundary_motion_map_fourway_aura_triad_and_start_choices_in_order() {
        ...
        let [boundary_path, motion_map_path, fourway_path, aura_triad_path, start_choices_path] =
