...
use hollow_grove::hueman_support::{
    ...
    hueman_path_crossovers_artifact_path, hueman_scene_drift_artifact_path,
...
fn run_hueman_at(root: &Path) -> io::Result<[PathBuf; 14]> {
...
mod tests {
    ...
    #[test]
    fn hueman_runner_regenerates_boundary_motion_map_fourway_aura_triad_start_choices_aura_behavior_archetype_lens_start_paths_path_crossovers_link_physics_crossover_scenes_scene_presence_scene_intent_and_scene_drift_in_order(
    ) {
        ...
        let [boundary_path, motion_map_path, fourway_path, aura_triad_path, start_choices_path, aura_behavior_path, archetype_lens_path, start_paths_path, path_crossovers_path, link_physics_path, crossover_scenes_path, scene_presence_path, scene_intent_path, scene_drift_path] =
