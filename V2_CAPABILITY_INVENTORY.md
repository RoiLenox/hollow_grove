...
| Central Junction geography | `CentralJunctionDistrict`, `JunctionApproach`, `HouseSectorHall` | Central Junction is a district; Exchange, Board, Clearing House, and Wire are institutions within it | stable district, institution, approach, and Hall IDs independent of catalog order | exact roster and geography tests | **Implemented without changing movement maps** |
