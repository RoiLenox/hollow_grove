...
- Gargoyle Surgeon = Being Hueman, Frame Gargoyle, species Gargoyle, training Glaushouse, profession Surgeon; specialty: Trauma, equipment: Jade Surgical Drain Set [Jade smooth filtered restorative surgical channels], Flow: Stonefold, Glow: none
- Elf Radiologist = Being Hueman, Frame Pixy, species Elf, training Glaushouse, profession Radiologist; specialty: Crystal imaging, equipment: Crystal Diagnostic Lens [Crystal faceted readable diagnostic crystal array], Flow: none, Glow: Projection
- Werewolf Emergency Nurse = Being Hueman, Frame Werewolf, species Werewolf, training Glaushouse, profession Nurse; specialty: Emergency response, equipment: Flynt Rescue Harness [Opal modular transforming motion-ready rescue rig], Flow: Moonrush, Glow: none
- Gnome Emergency Physician = Being Hueman, Frame Pixy, species Gnome, training Glaushouse, profession EmergencyPhysician; specialty: Intake triage, equipment: Crystal Triage Ledger [Crystal measured faceted readable dosage ledger], Flow: none, Glow: Recognition
